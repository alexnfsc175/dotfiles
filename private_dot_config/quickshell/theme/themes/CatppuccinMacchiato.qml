...
QtObject {
    readonly property string name: "catppuccin-macchiato"
    ...
    readonly property color accent: "#b7bdf8"
    readonly property color accentSecondary: "#8aadf4"

    readonly property color warning: "#eed49f"
    readonly property color error: "#ed8796"
    readonly property color success: "#a6da95"
    readonly property color info: "#91d7e3"
